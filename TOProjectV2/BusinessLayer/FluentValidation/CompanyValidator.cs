...
namespace BusinessLayer.FluentValidation
{
    public class CompanyValidator:AbstractValidator<Company>
    {
        public CompanyValidator()
        {
            ...
            RuleFor(x => x.SectorID).NotEmpty().WithMessage("FİRMA SEKTÖRÜ BOŞ GEÇİLEMEZ");
            ...
            RuleFor(x => x.CompanyOfficialStatus).NotEmpty().WithMessage("YETKİLİ STATÜSÜ BOŞ GEÇİLEMEZ.")
                .MinimumLength(3).WithMessage("YETKİLİ STATÜSÜ EN AZ 3 KARAKTERLİ OLMALI.")
                .MaximumLength(30).WithMessage("YETKİLİ STATÜSÜ EN FAZLA 30 KARAKTERLİ OLMALI.");
